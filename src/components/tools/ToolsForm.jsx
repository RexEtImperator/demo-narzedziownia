...
import { ArrowPathIcon, WifiIcon, EyeSlashIcon, ListBulletIcon } from '@heroicons/react/24/outline';
...
const ToolsForm = ({
  ...
  const content = (
    <div 
      ...
      className={isPage 
        ? "bg-white dark:bg-slate-800 rounded-lg shadow-sm w-full mt-2" 
          ...
          <div role="group">
            <div className="flex flex-wrap gap-2">
              {[
                ...
                { id: 'partially_issued', label: t('tools.filters.saved.partially_issued') || 'Wydane - częściowo', color: '#CDDC39' },
